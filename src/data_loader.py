...
def load_match_data(match_id, minutes=None):
    ...
    # Sync with events
    event_data = event_data[["event_id", "player_id", "frame_start", "frame_end", "event_type",
                              "team_id", "player_in_possession_id", "x_start", "y_start", "x_end", "y_end"]]
    
    synced = enriched_tracking_data.merge(event_data, left_on=["frame"], right_on="frame_end", how="left",
